...
gulp.task("default", ["client-styles", "client-scripts"], function () {
	...
	gulp.watch(appResources + "styles/**/*.scss", ["client-styles"]);
	gulp.watch(appResources + "scripts/**/*.js", ["client-scripts"]);
});
